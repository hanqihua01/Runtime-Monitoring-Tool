<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%" stripe>
            ...
            <el-table-column prop="raddr" label="源地址" sortable>
            </el-table-column>
            <el-table-column prop="rport" label="目的地址" sortable>
            </el-table-column>
            <el-table-column prop="laddr" label="端口号" sortable>
            </el-table-column>
            <el-table-column prop="lport" label="端口号" sortable>
            </el-table-column>
        </el-table>
    </div>
</template>
